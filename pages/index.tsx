...
const Home: NextPage = () => {
  return (
    <>
      <Button variants="contained" color='#0B65C6'>Пополнить</Button>
      <Button variants="outlined" color='#0B65C6'>Пополнить</Button>
      ...
      <Aside></Aside>
      <CardInfo title='Всего'currency='SWH' balance='1234.54' href='#' btnLabel='Вывести' ></CardInfo>
